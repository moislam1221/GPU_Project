...
void _jacobiGpuClassicIteration(float * x1,
                         ...
                         const float * leftMatrix, const float * centerMatrix,
                         const float * rightMatrix, int nGrids, int iteration)
{
...
int main(int argc, char *argv[])
{
    ...
    float * solutionCpu = jacobiCpu(initX, rhs, leftMatrix, centerMatrix, rightMatrix, nGrids, nIters);
    ...
    float * solutionGpuClassic = jacobiGpuClassic(initX, rhs, leftMatrix, centerMatrix, rightMatrix, nGrids, nIters, threadsPerBlock);
    ...
    float * solutionGpuSwept = jacobiGpuSwept(initX, rhs, leftMatrix, centerMatrix, rightMatrix, nGrids, nIters, threadsPerBlock);
